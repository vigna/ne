...
void update_partial_line(buffer *b, const line_desc *ld, int n, int64_t start_x, bool cleared_at_end, const bool differential);
void update_line(buffer *b, line_desc *ld, int n, const bool cleared_at_end, const bool differential);
