...
/* request.c */
int   request_strings(const char * const * const entries, int num_entries, int default_entry, int max_name_len, int mark_dirs);
...
/* search.c */
int  find(buffer *b, const unsigned char *pattern, int dir, int skip_first);
int  replace(buffer *b, int n, const char *string);
int  find_regexp(buffer *b, const unsigned char *regex, int dir, int skip_first);
